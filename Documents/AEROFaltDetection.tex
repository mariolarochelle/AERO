...
We tested our algorithms to two different real world datasets. Both of them are measurements coming from mast towers in Argentina for the period but the maintenance operations are unkwonw as well as any failure detected.
