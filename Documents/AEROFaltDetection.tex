...
\begin{figure}
	...
	\caption{time series measurements for  showing mechanical faults}
...
% Estoy repitiendo possible anomaly
% cuando una measurement pasa un threshold es marcada como anomalo. Explicar los 3 thresholds.
